...
from functional import DiceScore, Sensitivity, Specificity
...
class MetricTracker:
    ...
    Args:
        metrics (Iterable[str]): A list of metric names to be tracked. Available options: "dice", "sensitivity", and
            "specificity".
    """
